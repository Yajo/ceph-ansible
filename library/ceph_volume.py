...
def activate_osd(module, container_image):
    subcommand = "activate"
    cmd = build_ceph_volume_cmd(subcommand)
    cmd.append("--all")
...
def run_module():
    module_args = dict(
        ...
        action=dict(type='str', required=False, choices=[
                    'create', 'zap', 'batch', 'prepare', 'activate'], default='create'),  # noqa 4502
    ...
    # will return either the image name of None
